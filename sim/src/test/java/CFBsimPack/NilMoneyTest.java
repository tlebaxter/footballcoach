...
public class NilMoneyTest {
    ...
    @Test
    public void nilPurseCostIsNilOnly() {
        int scholly = NilMoney.nilPurseCost(RosterStatus.SCHOLARSHIP, 100000, 80);
        int plusNil = NilMoney.nilPurseCost(RosterStatus.SCHOLARSHIP_PLUS_NIL, 100000, 80);
        int pwo = NilMoney.nilPurseCost(RosterStatus.PWO, 100000, 80);
    ...
    @Test
    public void offerResourcesSplitsSlotsAndCash() {
        OfferResourceCost pwo = NilMoney.offerResources(RosterStatus.PWO, 100000);
        assertEquals(0, pwo.scholarshipSlots);
        assertEquals(0, pwo.annualNilCash);

        OfferResourceCost scholly = NilMoney.offerResources(RosterStatus.SCHOLARSHIP, 100000);
        assertEquals(1, scholly.scholarshipSlots);
        assertEquals(0, scholly.annualNilCash);

        OfferResourceCost plusNil = NilMoney.offerResources(RosterStatus.SCHOLARSHIP_PLUS_NIL, 100000);
        assertEquals(1, plusNil.scholarshipSlots);
        assertEquals(100000, plusNil.annualNilCash);
    }
